...
<style>
 ...
 /* Example EasyJet-like orange: #FFA500 */
.stTabs [data-baseweb="tab"] {
    background-color: #FFA500 !important; /* Unselected tab color */
    color: #FFF !important;               /* White text on orange */
    border-radius: 4px 4px 0px 0px;
    padding-top: 10px;
    padding-bottom: 10px;
    margin-right: 2px; /* optional spacing between tabs */
}

/* Slightly darker or different shade for the selected (active) tab */
.stTabs [aria-selected="true"] {
    background-color: #FF6600 !important; /* EasyJet brand orange */
    color: #FFF !important;               /* White text */
    border-bottom: 2px solid #FF6600;     /* or a highlight color */
}
